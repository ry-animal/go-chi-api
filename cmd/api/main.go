...
import (
	...
	"github.com/ry-animal/go-chi-api/internal/env"
	"github.com/ry-animal/go-chi-api/internal/smtp"
	"github.com/ry-animal/go-chi-api/internal/version"
...
func run(logger *slog.Logger) error {
	...
	cfg.cookie.secretKey = env.GetString("COOKIE_SECRET_KEY", "2pjolbqv6pdrmmjzq3cesh4dit2lx2sm")
	cfg.db.dsn = env.GetString("DB_DSN", "user:pass@tcp(localhost:3306)/example?parseTime=true")
	cfg.db.automigrate = env.GetBool("DB_AUTOMIGRATE", true)
	cfg.jwt.secretKey = env.GetString("JWT_SECRET_KEY", "iznh2jainm4cywbzdzdm5ertkdj3ua5y")
